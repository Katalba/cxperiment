...
const CardPrecentacion = () => {
  return (
    <section className='cardPrecentacion w-full max-w-[1650px] h-auto bg-whiteWi flex flex-col justify-start items-center gap-4 p-5  sm:flex-row sm:justify-evenly sm:items-center md:gap-4 md:p-6 '>
      ...
      <section className='w-full h-[230px] sm:w-1/2 sm:h-[280px] md:w-[400px] md:h-[250px] lg:w-1/2 lg:h-[250px] xl:w-1/2 xl:h-[230px] flex flex-col justify-center items-center border-verdeTurk border-2 rounded-[0] rounded-t-[50px] rounded-tr-[0] rounded-b-[50px] rounded-l-[50px]  p-5 overflow-hidden gap-2 lg:gap-3'>
      ...
      <section className='w-full h-[230px] sm:w-1/2 sm:h-[280px] md:w-[400px] md:h-[250px] lg:w-1/2 lg:h-[250px] xl:w-1/2 xl:h-[230px] flex flex-col justify-center items-center  border-verdeTurk border-2 rounded-[0] rounded-t rounded-tr-[50px] rounded-br-[50px] rounded-bl-[50px]  p-5 overflow-hidden gap-2 lg:gap-3'>
