...
const CardPrecentacion = () => {
  return (
    <section className='cardPrecentacion w-full max-w-[1650px] h-auto bg-whiteWi flex flex-col justify-start items-center gap-4 p-5  sm:flex-row sm:justify-evenly sm:items-center md:gap-4 md:p-6 '>
      <section className='w-full h-[290px] sm:w-1/2 sm:h-[290px] md:w-1/2 md:h-[270px] lg:w-1/2 lg:h-[280px] xl:w-1/2 xl:h-[290px] flex flex-col justify-center items-center border-verdeTurk border-2 p-5 overflow-hidden gap-2 lg:gap-3'>
