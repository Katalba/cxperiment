...
const FlipCard = ({ objeto }) => {
  ...
  return (
    <section className='flipCard group w-[190px] h-[190px] min-[450px]:w-[250px] min-[450px]:h-[250px] sm:w-[310px] sm:h-[310px] md:w-[200px] md:h-[200px] lg:w-[290px] lg:h-[290px] xl:w-[320px] xl:h-[320px]  2xl:w-[350px] 2xl:h-[350px] aspect-square p-0 '>
