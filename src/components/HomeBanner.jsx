    ...
    >
      <SwiperSlide>
        <div className='h-[915px] flex'>
          ...
          <div className='homeTitle space-y-[2rem] flex flex-col absolute top-[50%] sm:left-[1rem] lg:left-[3rem] sm: w-1/2 lg:w-2/5'>
            <h1 className='font-medium leading-[60px] sm:text-[34px] md:text-[50px] lg:text-[56px]'>Convertí a tus clientes en tus fans</h1>
