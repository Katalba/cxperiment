  ...
  return (
    <>
      ...
      >
        ...
        <div className='containerTitle relative w-full h-3/5 sm:h-1/2 md:w-3/5 md:h-full md:absolute md:top-0 md:left-0 lg:w-3/5  flex flex-col justify-center items-center md:items-center  md:text-left lg:text-left '>
