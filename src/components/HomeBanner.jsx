...
const HomeBanner = () => {
  return (
    <div id='home' className='homeImage w-full h-[161px] md:h-[380px] lg:h-[500px] mt-[90px] bg-cover bg-center relative -z-0 mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
