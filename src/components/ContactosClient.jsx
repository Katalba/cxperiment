...
const ContactosClient = () => {
  ...
  return (
    <section className='contenidoContacto card-scroll w-full h-full lg:w-1/2 flex flex-col justify-start items-start gap-6 p-6'>
      <section className='w-full h-auto md:w-[80%] lg:w-full xl:w-[620px] xl:h-auto bg-bgForm rounded-lg px-5 md:px-5 lg:px-0 xl:px-8 py-14 flex flex-col justify-center items-center gap-5 lg:gap-6 xl:gap-7 border-[.5px]'>
